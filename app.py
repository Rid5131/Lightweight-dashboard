...
from utils.chart import plot_candlestick_chart_lightweight
...
data = pd.read_csv("C:/New folder/tsla_dashboard/data/TSLA_data - Sheet1.csv")
plot_candlestick_chart_lightweight(data)
